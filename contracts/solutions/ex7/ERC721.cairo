...
func tokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (arr) = alloc();
    assert arr[0] = 184555836509371486644298270517380613565396767415278678887948391494588524912;
    assert arr[1] = 181013377130045435659890581909640190867353010602592517226438742938315085926;
    assert arr[2] = 2194400143691614193218323824727442803459257903;
    assert arr[3] = 49;
    assert arr[4] = 199354445678;
    return (token_uri_len=5, token_uri=arr);
}
